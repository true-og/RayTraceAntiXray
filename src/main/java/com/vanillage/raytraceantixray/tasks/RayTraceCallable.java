...
public final class RayTraceCallable implements Callable<Void> {
    ...
    public RayTraceCallable(PlayerData playerData) {
        ...
        cachedSectionBlockOcclusionGetter = new CachedSectionBlockOcclusionGetter() {
            ...
            public boolean isOccluding(int x, int y, int z) {
                ...
                if (this.chunkX != chunkX || this.chunkZ != chunkZ) {
                    ...
                    return section != null && !section.hasOnlyAir()
                            && solidGlobal[ChunkPacketBlockControllerAntiXray.GLOBAL_BLOCKSTATE_PALETTE
                                    .idFor(getBlockState(section, x, y, z))]; // Sections aren't null anymore.
                                                                              // Unfortunately,
                                                                              // LevelChunkSection#recalcBlockCounts()
                                                                              // temporarily resets #nonEmptyBlockCount
                                                                              // to 0 due to a Paper optimization.
                ...
                return solidGlobal[ChunkPacketBlockControllerAntiXray.GLOBAL_BLOCKSTATE_PALETTE
                        .idFor(getBlockState(section, x, y, z))];
        ...
        blockOcclusionCulling = new BlockOcclusionCulling(blockIterator::initializeNormalized,
                cachedSectionBlockOcclusionGetter, true);
                ...
                for (int i = 0; i < locations.length; i++) {
                    ...
                    if (i == 0) {
                        ...
                        if (blockOcclusionCulling.isVisible(x, y, z, centerX, centerY, centerZ, differenceX,
                                differenceY, differenceZ, distanceSquared, direction.getX(), direction.getY(),
                                direction.getZ()))
                        {
                        ...
                        double vectorDistanceSquared = vectorDifferenceX * vectorDifferenceX
                                + vectorDifferenceY * vectorDifferenceY + vectorDifferenceZ * vectorDifferenceZ;

                        if (blockOcclusionCulling.isVisible(x, y, z, centerX, centerY, centerZ, vectorDifferenceX,
                                vectorDifferenceY, vectorDifferenceZ, vectorDistanceSquared, direction.getX(),
