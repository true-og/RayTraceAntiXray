...
public final class BlockIterator implements Iterator<int[]> {
    ...
    public BlockIterator(int x, int y, int z, double startX, double startY, double startZ, double endX, double endY,
            double endZ)
    {
    ...
    public BlockIterator(double startX, double startY, double startZ, double directionX, double directionY,
            double directionZ, double distance)
    {
    ...
    public BlockIterator(int x, int y, int z, double startX, double startY, double startZ, double directionX,
            double directionY, double directionZ, double distance)
    {
    ...
    public BlockIterator(double startX, double startY, double startZ, double directionX, double directionY,
            double directionZ, double distance, boolean normalized)
    {
    ...
    public BlockIterator(int x, int y, int z, double startX, double startY, double startZ, double directionX,
            double directionY, double directionZ, double distance, boolean normalized)
    {
    ...
    public BlockIterator initialize(double startX, double startY, double startZ, double endX, double endY,
            double endZ)
    {
    ...
    public BlockIterator initialize(int x, int y, int z, double startX, double startY, double startZ, double endX,
    ...
    public BlockIterator initialize(double startX, double startY, double startZ, double directionX, double directionY,
            double directionZ, double distance)
    {

        return initialize(floor(startX), floor(startY), floor(startZ), startX, startY, startZ, directionX, directionY,
                directionZ, distance);

    }

    public BlockIterator initialize(int x, int y, int z, double startX, double startY, double startZ, double directionX,
            double directionY, double directionZ, double distance)
    {
        ...
        directionY /= length;
        directionZ /= length;
        return initializeNormalized(x, y, z, startX, startY, startZ, directionX, directionY, directionZ,
                Math.abs(distance));

    }

    public BlockIterator initializeNormalized(double startX, double startY, double startZ, double directionX,
            double directionY, double directionZ, double distance)
    {

        return initializeNormalized(floor(startX), floor(startY), floor(startZ), startX, startY, startZ, directionX,
